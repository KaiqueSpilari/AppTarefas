...
namespace AppTarefas.Controllers
{
    public class TarefasController : Controller
    {
        ...
        {
            return View(_tarefas); // Envia a lista e tarefas como parametro para a pagina Index.
        }
        ...
        public IActionResult Create(Tarefa tarefa)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Index"); // Redireciona para a pagina Indes
            }
            return View(tarefa);
        }
        ...
        public IActionResult Edit(int id, Tarefa tarefaAtualizada)
        {
            ...
            tarefa.Título = tarefaAtualizada.Título;
